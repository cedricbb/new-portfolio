...
export default function Home() {
  ...
  return (
      <main className="h-[100vh] text-white py-12 relative">
          ...
          <div className="flex items-center justify-center overflow-hidden">
              <div className="max-w-(--breakpoint-xl) w-full mx-auto grid lg:grid-cols-2 gap-12 px-6 py-12 md:py-12">
                  ...
                  <div className="w-full h-full place-self-center my-auto flex items-center justify-center flex-row">
                      <div className="rounded-full w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative bg-gradient-to-r from-[var(--popover-foreground)] to-[var(--secondary-foreground)]">
